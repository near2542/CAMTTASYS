...
<html lang="en">
  ...
  INNER JOIN ta_request t on m.m_course_id = t.m_course_id
        ...
        <!---------------- ---------------------------->
          ...
          <tr>
            ...
            <?php elseif($data['approved'] == 1):?> 
              <button class="btn btn-info" data-target="#edit<?=$data['m_course_id']?>" disabled data-toggle="modal">Edit</button>
              <?php endif; ?>
            </td>
